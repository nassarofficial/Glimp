...
- (id)initWithThumbnail:(JPSThumbnail *)thumbnail {
    ...
    if (self) {
        ...
        _userName = thumbnail.userName;
        _videoUrl = thumbnail.videoUrl;
        _videoComment = thumbnail.videoComment;
        _videoID = thumbnail.videoID;
        _noOfComments = thumbnail.noOfComments;
        _noOfViews = thumbnail.noOfViews;
        _noOflikes = thumbnail.noOflikes;
        _videoImage = thumbnail.videoImage;
        _isLiked = thumbnail.isLiked;
        _videoLocation = thumbnail.videoLocation;
        _videoTime = thumbnail.videoTime;
        _userID    = thumbnail.userID;
    }
    return self;
}
