<?
$dbname            ='glimp'; //Name of the database
$dbuser            ='root'; //Username for the db
$dbpass            ='E663%156Z>z9d{$Ql395%2uH761oX9dP'; //Password for the db
...
<script type="text/javascript">
 ...
 function addMarker(id, lat, lng, filename, name, desc) {
   var id = id;
   var filenamer= filename;
   var contentString = "<img src='../thumbnail/"+filename+".png' style='margin:5px;' alt='image in infowindow' align='left' width='60' height='60' border='0' href='video?id="+id+"'><b>"+name+"</b></br> <p.small style='line-height: 0.4'>"+desc+"<br></p>";
...
$current = (string)$today;
 ...
 $query = mysql_query("SELECT * FROM glimps WHERE stoptime > '".$current."'");
 ...
 echo ("addMarker($id, $lat, $lon,'$filename','$name','$desc');\n");
 }
 ?>
