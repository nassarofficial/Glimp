...
- (void)setTableHeader
{
    ...
    if (self.myProfile) {
        ...
        [self.follow setImage:nil forState:UIControlStateNormal];
        ...
        CGRect rect = self.follow.frame;
        rect.size.height = 25;
        self.follow.frame = rect;
        self.follow.layer.borderWidth = 1.0f;
        self.follow.layer.borderColor = [UIColor darkGrayColor].CGColor;
        self.follow.layer.masksToBounds = NO;
        self.follow.layer.cornerRadius = 6.0f;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *CellIdentifier2 = @"VideoCell";
        ...
        if (videos.count!=0) {
            ...
            videocell.nameLabel.text = video.userName;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [ [appDelegate.navg.viewControllers lastObject]  presentViewController:video animated:YES completion:nil];
