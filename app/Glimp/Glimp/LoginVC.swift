...
class LoginVC: UIViewController, UITextFieldDelegate, FBSDKLoginButtonDelegate {
            ...
            else
            {
                ...
                if ( urlData != nil ) {
                    ...
                    if (res.statusCode >= 200 && res.statusCode < 300)
                    {
                        ...
                        let responseData1: String = (responseData as NSString).substringToIndex(11)
                        ...
                        else if (responseData1 == "{\"success\":") {
                            self.spinner.hidden = true
                            let test = responseData as String
                            let text = (test as NSString).substringFromIndex(11)
                            let prefs:NSUserDefaults = NSUserDefaults.standardUserDefaults()
                            
                           // prefs.setObject(self.fbusername, forKey: "USERNAME")
                            prefs.setObject(text, forKey: "USERNAME")
    ...
    func fbregisteruser(){
        ...
        let nextAction: UIAlertAction = UIAlertAction(title: "Register", style: .Default) { action -> Void in
            ...
            let verifier = userName!.characters.count
            ...
            else if (( nouser.indexOf((userName)!)) != nil) {
