...
@property(nonatomic, strong) JPSThumbnail *leadObject;
...
-(BOOL)insertObject:(JPSThumbnail *)insertableObject
{
  if( self.leadObject ) {
...
-(QNode* __strong *)childNodeForObject:(JPSThumbnail *)insertableObject
{
...
-(BOOL)insertLeadObject:(JPSThumbnail *)leadObject withSatellites:(NSSet*)satellites
{
  self.cachedCluster = nil;
